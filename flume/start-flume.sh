...
flume-ng agent \
  ...
  -n ${FLUME_AGENT_NAME} \
  -Dlog4j.configuration=file://${FLUME_CONF_DIR}/log4j.properties \
  -C /opt/hadoop/share/hadoop/hdfs/*:/opt/hadoop/share/hadoop/common/*:/opt/hadoop/share/hadoop/common/lib/* \
  $*
